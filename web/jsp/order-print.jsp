...
<p class="total">Tổng cộng: <fmt:formatNumber value="${order.tongTien}" type="number"/> VNĐ</p>
...
<div class="footer">
    ...
    <p>Trang in tự động lúc <fmt:formatDate value="<%= new java.util.Date() %>" pattern="HH:mm dd/MM/yyyy"/></p>
</div>

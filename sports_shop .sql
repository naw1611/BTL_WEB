...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 24, 2025 at 08:16 AM
...
(17, 12, 19, 1, 3700000.00),
(18, 13, 33, 1, 1305000.00),
(19, 13, 2, 1, 150000.00),
(20, 14, 1, 1, 200000.00),
(21, 15, 19, 1, 3700000.00),
(22, 16, 4, 1, 300000.00),
(27, 19, 30, 1, 270000.00),
(28, 19, 31, 1, 160000.00);
...
CREATE TABLE `donhang` (
  ...
  `AnhChuyenKhoan` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `donhang` (`MaDon`, `MaUser`, `NgayDat`, `TongTien`, `TrangThai`, `DiaChiGiao`, `SDT`, `TenNguoiNhan`, `PhuongThucThanhToan`, `AnhChuyenKhoan`) VALUES
(1, 3, '2025-10-27 00:00:00', 769000.00, 'Đã hủy', '101 Đường Test, TP. Thủ Đức', NULL, NULL, 'COD', NULL),
(2, 2, '2025-10-28 00:00:00', 4500000.00, 'Đã giao hàng', '999 Đường Quản Lý, Q. Phú Nhuận, TP.HCM', NULL, NULL, 'COD', NULL),
(3, 1, '2025-10-28 00:00:00', 179000.00, 'Đang giao hàng', '303 Hẻm VIP, Đà Nẵng', NULL, NULL, 'COD', NULL),
(4, 6, '2025-10-29 00:00:00', 1020000.00, 'Đã giao hàng', 'Phú Thọ', NULL, NULL, 'COD', NULL),
(7, 6, '2025-11-03 16:30:30', 1550000.00, 'Đã hủy', 'Phú Thọ', '0967730504', 'Trần Anh Nam', 'COD', NULL),
(10, 6, '2025-11-07 14:30:31', 379400.00, 'Đã giao hàng', 'Phú Thọ', '0967730504', 'Trần Anh Nam', 'COD', NULL),
(11, 7, '2025-11-12 11:00:13', 250000.00, 'Đã giao hàng', 'Hải Dương', '0373994214', 'Nguyễn Thị Huyền Trang', 'COD', NULL),
(12, 8, '2025-11-16 22:16:56', 3700000.00, 'Đã hủy', 'Thái Bình', '0335787267', 'Bùi Thị Như Quỳnh', 'COD', NULL),
(13, 8, '2025-11-16 22:18:01', 1455000.00, 'Đã giao hàng', 'Thái Bình', '0335787267', 'Bùi Thị Như Quỳnh', 'COD', NULL),
(14, 8, '2025-11-16 22:57:40', 200000.00, 'Đã hủy', 'Thái Bình', '0335787267', 'Bùi Thị Như Quỳnh', 'COD', NULL),
(15, 8, '2025-11-16 23:07:20', 3700000.00, 'Đã đặt', 'Thái Bình', '0335787267', 'Bùi Thị Như Quỳnh', 'COD', NULL),
(16, 6, '2025-11-24 08:38:35', 300000.00, 'Đã đặt', 'Vĩnh Phúc', '0967730504', 'Trần Anh Nam', 'Chuyển khoản', 'uploads/chuyen-khoan/16_uneti-logo.png'),
(19, 7, '2025-11-24 13:41:39', 430000.00, 'Đã đặt', 'Hải Dương', '0373994214', 'Nguyễn Thị Huyền Trang', 'Chuyển khoản', 'uploads/chuyen-khoan/19_meomeo.png');
...
(37, 'KM 19-11', 'Giảm giá cho ngày của cánh đàn ông con trai', '2025-11-15', '2025-11-19', 15.00);
...
(6, 6, 'Trần Anh Nam', 'namanh272xh@gmail.com', 'tôi cần bạn tư vấn thêm về giày trượt patin', '2025-11-16 21:43:58', 'Đã phản hồi', '2TQN xin chào , không biết là bạn có thắc mắc gì về giày nhỉ ? Ví dụ như size giày , độ bền ...', '2025-11-16 21:45:46');
...
(10, 1, 6, 5, 'sản phẩm oke nha mn', '2025-11-16 14:45:59', 'Cảm ơn bạn đã ủng hộ cửa hàng của chúng tôi . Hi vọng sẽ gặp lại bạn ở đơn hàng tiếp theo', '2025-11-16 22:24:10');
...
(1, 'Bóng Đá', 'BD001', 250000.00, 50, 'bongda.jpg', 'Màu xanh lá, đen, đỏ, vàng, xanh dương, cam; Chu vi 70, đường kính 22', 2, 1, 0),
(2, 'Cầu Lông', 'CL001', 150000.00, 99, 'caulong.jpg', '12 quả/ bộ', 1, NULL, 0),
(3, 'Bóng Bàn', 'BB001', 70000.00, 200, 'bongban.jpg', 'Màu cam, xanh lá; Chu vi 12.5, đường kính 4', 2, NULL, 0),
(4, 'Bóng Rổ', 'BR001', 300000.00, 29, 'bongro.jpg', 'Chu vi 76, đường kính 24', 2, NULL, 0),
(5, 'Bóng Chày', 'BC001', 280000.00, 40, 'bongchay.jpg', 'Chu vi 23, đường kính 7.4', 2, NULL, 0),
(6, 'Bóng Pickleball', 'BP001', 150000.00, 60, 'bongpickle.jpg', '6 quả/ bộ; Chu vi 7.4, đường kính 7.4', 2, NULL, 0),
...
(19, 'Gậy Golf', 'GG001', 3700000.00, 18, 'gaygolf.jpg', '', 5, 19, 0),
...
(30, 'Thảm Tập Yoga', 'TY001', 270000.00, 39, 'tham.jpg', 'Màu hồng, tím, vàng, cam, xanh lá, đỏ, xanh dương, đen, trắng', 6, 30, 0),
(31, 'Dây Kháng Lực', 'DKL001', 160000.00, 49, 'daykhangluc.jpg', 'Màu hồng, tím, vàng, cam, xanh lá, đỏ, xanh dương, đen, trắng', 6, 30, 0),
...
(33, 'Giày Patin', 'GP001', 1500000.00, 34, 'giaypatin.jpg', 'Giảm giá còn 1.299.000 VNĐ; Màu hồng, tím, vàng, cam, xanh lá, đỏ, xanh dương, đen, trắng; size 32-43', 7, 32, 0),
...
(37, 'Bộ thể thao', 'TT0001', 200000.00, 70, 'bo-the-thao.png', 'bộ thể thao thoáng mát , dễ vận động', 6, NULL, 0);
...
(1, 'admin', 'Admin', '$2a$10$IlQ8PuYImVMrNlAmW8UhIeLsNFpWnfEelcilKwtmuA1hZZRvxzD66', 'superadmin@shop.com', '0900112233', '999 Đường Quản Lý, Q. Phú Nhuận, TP.HCM', '2025-10-27 16:13:09', 'admin', 1),
...
(8, 'quynh2812', 'Bùi Thị Như Quỳnh', '$2a$12$MCi8YkqEO7SwCaKpwPV4l.82Juvk.na1Wrvhn1lkrBcLTdCnYjbrG', 'buithinhuquynh553@gmail.com', '0335787267', 'Thái Bình', '2025-10-27 17:14:52', 'user', 1),
...
(10, 'vanc12345', 'Nguyễn Văn C', '$2a$10$s7YPi8DzULgL/oWSduGrt.RDqK8IGMclPtmEUDXVIpnIkCci7v6eS', 'vancxh@gmail.com', '0123456789', 'ABC', '2025-11-16 22:21:22', 'user', 1);
...
--
ALTER TABLE `cartitems`
  MODIFY `MaCart` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;

--
-- AUTO_INCREMENT for table `chitietdonhang`
--
ALTER TABLE `chitietdonhang`
  MODIFY `MaChiTiet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `donhang`
  MODIFY `MaDon` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `khuyenmai`
--
ALTER TABLE `khuyenmai`
  MODIFY `MaKM` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
